...
## 5. Environmental Tech Integration

### Recipe Gating - Void Ore Miners
- [ ] **T1 Void Miner** requires Advanced Circuit + Diamond Gear + Litherite Crystal
- [ ] **T2 Void Miner** requires T1 + Erodium Crystal + Diamond Block
- [ ] **T3 Void Miner** requires T2 + Draconium Ingots + Draconic Core
- [ ] **T4 Void Miner** requires T3 + Draconic Cores + Draconium Block
- [ ] **T5 Void Miner** requires T4 + Wyvern Cores + Awakened Draconium
- [ ] **T6 Void Miner** requires T5 + Awakened Core + Chaos Shards

> Notes:

### Recipe Gating - Void Resource Miners
- [ ] T1-6 Resource Miners follow same gating pattern as Ore Miners

### Recipe Gating - Solar Arrays
- [ ] **T1-T2 Solar** CANNOT be crafted (recipes removed)
- [ ] **T3 Solar** requires Draconic Cores + Energy Storage Core
- [ ] **T4+ Solar** requires increasingly rare Draconic materials

> Notes:

### Recipe Gating - Other Features
- [ ] **Lightning Rod** requires Advanced Circuit + Iron Gear (light gating)
- [ ] **Nanobot Beacon** requires Beacon + Litherite (light gating)

### Crystal Progression
- [ ] **Litherite Crystal** requires Basic Circuit + Diamond
- [ ] **Erodium Crystal** requires Advanced Circuit + Litherite Crystals
- [ ] **Kyronite Crystal** requires Draconium Ingot
- [ ] **Pladium Crystal** requires Draconic Core
- [ ] **Ionite Crystal** requires Wyvern Core
- [ ] **Aethium Crystal** requires Awakened Core

> Notes:

### Functionality Testing
- [ ] Void Ore Miner T1 multiblock forms correctly
- [ ] Void Ore Miner produces ores when powered
- [ ] Power consumption scales with tier (T1: ~2K RF/t, T6: ~200K RF/t)
- [ ] Lightning Rod generates RF during storms
- [ ] Nanobot Beacon provides buffs

### EMC Values
- [ ] Litherite Crystal shows 4,096 EMC
- [ ] Erodium Crystal shows 8,192 EMC  
- [ ] Kyronite Crystal shows 16,384 EMC
- [ ] Pladium Crystal shows 32,768 EMC
- [ ] Ionite Crystal shows 65,536 EMC
- [ ] Aethium Crystal shows NO EMC
- [ ] All Void Miner Controllers show NO EMC
- [ ] All Solar Controllers show NO EMC

> Notes:

---

## 6. Cross-Mod Integration
